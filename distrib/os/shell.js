...
(function (TSOS) {
    class Shell {
        ...
        init() {
            ...
            this.commandList[this.commandList.length] = sc;
            // load
            sc = new TSOS.ShellCommand(this.shellLoad, "load", "<priority> - Loads program from User Program Input.  Priority optional, except in Priority scheduling.");
            this.commandList[this.commandList.length] = sc;
            // run
            sc = new TSOS.ShellCommand(this.shellRun, "run", "<pid> - Runs specified process.");
            this.commandList[this.commandList.length] = sc;
            // runall
            sc = new TSOS.ShellCommand(this.shellRunAll, "runall", "Runs all processes in 'process' state.");
            this.commandList[this.commandList.length] = sc;
            // clearmem
            sc = new TSOS.ShellCommand(this.shellClearMem, "clearmem", "Clears all memory segments. (Ignores running processes.)");
            this.commandList[this.commandList.length] = sc;
            // ps
            sc = new TSOS.ShellCommand(this.shellPs, "ps", "Lists running processes and their PIDs.");
            this.commandList[this.commandList.length] = sc;
            // kill
            ...
            this.commandList[this.commandList.length] = sc;
            // quantum
            sc = new TSOS.ShellCommand(this.shellQuantum, "quantum", "<int> - Sets quantum for Round Robin scheduling.");
            this.commandList[this.commandList.length] = sc;
            // getscheduler
            ...
            this.commandList[this.commandList.length] = sc;
            // format
            sc = new TSOS.ShellCommand(this.shellFormat, "format", "<-quick, -full> - Initializes data blocks.  Quick only initializes 1st 4, Full initializes entire block.");
            this.commandList[this.commandList.length] = sc;
            // create
            sc = new TSOS.ShellCommand(this.shellCreate, "create", "<filename> - Creates file.");
            this.commandList[this.commandList.length] = sc;
            // read
            sc = new TSOS.ShellCommand(this.shellRead, "read", "<filename> - Outputs contents of specified file.");
            this.commandList[this.commandList.length] = sc;
            // write
            sc = new TSOS.ShellCommand(this.shellWrite, "write", "<filename> <text> - Writes data within quotes to specified file.");
            this.commandList[this.commandList.length] = sc;
            // delete
        ...
        shellLoad(args) {
            ...
            */
            ...
            var program = document.getElementById("taProgramInput").value.trim().toLocaleUpperCase();
